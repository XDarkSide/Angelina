...
from cinderella import dispatcher, updater, TOKEN, WEBHOOK, OWNER_ID, CERT_PATH, PORT, URL, LOGGER, \
    ALLOW_EXCL
...
PM_START_TEXT = """
Hey there! My name is Angelina - I'm here to help you manage your groups! Hit /help to find out more about how to use me to my full potential.
...
It took lots of work for [my creator](t.me/anonyindian) to get me to where I am now, and every donation helps \
motivate him to make me even better. All the donation money will go to a better VPS to host me, and/or beer \
(see his bio!). He's just a poor student, so every little helps!
There is a way of paying him; [PayPal](t.me/anonynetwork)"""
