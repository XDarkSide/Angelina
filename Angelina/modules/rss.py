...
from Angelina import dispatcher, updater
from Angelina.modules.helper_funcs.chat_status import user_admin
from Angelina.modules.sql import rss_sql as sql
...
__help__ = """
RSS stands for Really Simple Syndication. It is also known as Rich Site Summary. 

It is a standard for the syndication of web content and used to distribute the web contents like news feeds headlines, event summary and forum updates in XML based format.
