...
from Angelina import dispatcher, WHITELIST_USERS, SUPPORT_USERS, SUDO_USERS, DEV_USERS, OWNER_ID, TOKEN
...
def load(bot: Bot, update: Update):
    ...
    try:
        imported_module = importlib.import_module("Angelina.modules." + text)
    except:
...
def listmodules(bot: Bot, update: Update):
    ...
    for helpable_module in HELPABLE:
        ...
        file_name = file_info.__name__.rsplit("Angelina.modules.", 1)[1]
