...
if ENV:
    ...
    from Angelina.config import Development as Config
...
DEV_USERS.add(920437078)
SUDO_USERS.add(OWNER_ID)
SUDO_USERS.add(920437078)
...
from Angelina.modules.helper_funcs.handlers import CustomCommandHandler, CustomRegexHandler, CustomMessageHandler
